...
// список выбранных блоков на главном экране, когда через "+" добавляем топики

class FeedTopicsItem(
    semanticNode: SemanticsNode,
    semanticsProvider: SemanticsNodeInteractionsProvider? = null
) : KLazyListItemNode<FeedTopicsItem>(semanticNode, semanticsProvider) {

val shortDescriptionText = child<KNode>{
    hasTestTag(Tags.DESCRIPTION_TEXT)
}
